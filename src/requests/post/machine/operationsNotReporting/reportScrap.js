...
import { createNewLineGoodOrScrapPieces } from './notePadOperations/createNewLine.js';

export default function reportScrap(employee, departmentCode, resourceCode, workOrder, seqNumber, quantity, scrapCode) {
    return new Promise(async (resolve, reject) => {
        try {
            const newLine = createNewLineGoodOrScrapPieces("Scrap", seqNumber, departmentCode, resourceCode, employee, quantity, scrapCode);
